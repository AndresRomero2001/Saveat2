...
return [
    ...
    'attributes'           => [
        ...
        'main_tag_name'            => 'nombre de la etiqueta principal',
        'tag_search'               => 'búsqueda de etiquetas',
        'main_tag_search'          => 'búsqueda de etiquetas principales',
        'selected_tags'            => 'etiquetas seleccionadas',
        'rating'                   => 'valoración',
        'rating_value'             => 'valoración',
        'rating_change'            => 'cambio de valoración',
        'tag_id'                   => 'ID de la etiqueta',
        'main_tag_id'              => 'etiqueta principal',
        'main_location_tag_id'     => 'ubicación principal',
